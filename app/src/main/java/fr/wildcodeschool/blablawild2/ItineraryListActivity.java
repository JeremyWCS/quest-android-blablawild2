...
public class ItineraryListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // précise le type de layout de la liste
        ...
        // affiche la liste d'itinéraires avec un adapter
        ...
        listItineraries.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), listItineraries, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Toast.makeText(getApplicationContext(), itinerary.getDriver() + " is selected!", Toast.LENGTH_SHORT).show();
            }
